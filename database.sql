-- FILE IS DEPRECATED, CREATE SCHEME AND START THE BACKEND SERVER TO CREATE THE DATABASE
...
(
    ...
    CONSTRAINT fk_posts_genres FOREIGN KEY (fk_genre) REFERENCES genres (id),
