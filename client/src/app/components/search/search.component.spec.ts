...
//       isPost: jasmine.createSpy('isPost'),
//       isUser: jasmine.createSpy('isUser'),
//       isArtist: jasmine.createSpy('isArtist'),
//       isSong: jasmine.createSpy('isSong'),
...
//
//       expect(component.combinedList.length).toBe(1);
//       expect(component.combinedList[0]).toEqual(jasmine.objectContaining({ username: 'user' }));
//     });
//
